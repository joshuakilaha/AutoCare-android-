...
import com.example.myautocare.Mylocation.PlaceAutocompleteAdapter;
import com.example.myautocare.Mylocation.PlaceInfo;
...
public class Mylocation extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.
                ...
                locaton.addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull com.google.android.gms.tasks.Task<Location> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(Mylocation.this,"unable to get current location",Toast.LENGTH_LONG).show();
                        }
